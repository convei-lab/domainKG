...
def run_generating(args):
    ...
    # yujin add
    path_embedding_file = os.path.join(args.output_path, 'path_embedding.pickle')
    ...
    # yj added
    pretrain_generator_ckpt = args.pretrain_generator_ckpt_path
    ...
    print("save_path : ", path_embedding_file)
    print('Finish.')
...
def main():
    ...
    parser.add_argument('--pretrain_generator_ckpt_path', type=str, default='./saved_models/pretrain_generator/model.ckpt')
    parser.add_argument('--output_path', type=str, default='./path_embeddings/')
