...
def main():
    ...
    parser.add_argument('--path_embedding_path', default="/home/yujin/dot/commonsense-qa/path_embeddings")
...
def train(args):
    ...
    path_embedding_path = args.path_embedding_path
    print("path embedding path is : {}".format(path_embedding_path))
...
def pred(args):
    ...
    dataset = LMRelationNetDataLoaderForPred(path_embedding_path, 
                                      old_args.test_statements, 
                                      old_args.test_rel_paths,
                                      batch_size=args.batch_size, eval_batch_size=args.eval_batch_size, device=device,
                                      model_name=old_args.encoder,
                                      max_tuple_num=old_args.max_tuple_num, max_seq_length=old_args.max_seq_len,
                                      is_inhouse=args.inhouse, inhouse_train_qids_path=args.inhouse_train_qids,
                                      use_contextualized=use_contextualized,test_adj_path=args.test_adj,
                                      test_node_features_path=args.test_node_features, node_feature_type=args.node_feature_type)
